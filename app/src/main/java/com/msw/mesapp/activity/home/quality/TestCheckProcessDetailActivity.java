 ...
 * 化验审核之产品审核之详细
 */
public class TestCheckProcessDetailActivity extends AppCompatActivity {
                ...
                .execute(new SimpleCallBack<String>() {
                    ...
                    public void onSuccess(String result) {
                        ...
                        if (code == 0) {
                            ...
                            ToastUtil.showToast(TestCheckProcessDetailActivity.this, message, ToastUtil.Error);
                        }
                    }

                    @Override
                    public void onError(ApiException e) {
                        ToastUtil.showToast(TestCheckProcessDetailActivity.this, GlobalApi.ProgressDialog.INTERR, ToastUtil.Confusion);
                    }
                });
    }
    ...
    private void initView() {
        ...
        String Path = "";
        switch (ctype){
            case "1": Path = GlobalApi.Quality.ProcessPremix.Audit.PATH;break;
            case "2": Path = GlobalApi.Quality.ProcessSize.Audit.PATH;break;
            case "3": Path = GlobalApi.Quality.ProcessLithium.Audit.PATH;break;
            case "4": Path = GlobalApi.Quality.ProcessBuckle.Audit.PATH;break;
            default:Path = GlobalApi.Quality.ProcessPremix.Audit.PATH;break;
        }
                ...
                EasyHttp.post(finalPath)
                        ...
                        .execute(new SimpleCallBack<String>() {
                            ...
                            public void onSuccess(String result) {
                                ...
                                if (code == 0) {
                                    ToastUtil.showToast(TestCheckProcessDetailActivity.this, message, ToastUtil.Success);
                                    finish();
                                } else {
                                    ToastUtil.showToast(TestCheckProcessDetailActivity.this, message, ToastUtil.Error);
                                }
    ...
    private void initTable() {
        ...
        ICellBackgroundFormat<CellInfo> backgroundFormat = new BaseCellBackgroundFormat<CellInfo>() {
            ...
            public int getBackGroundColor(CellInfo cellInfo) {
                if (cellInfo.row % 2 == 0) {
                    return ContextCompat.getColor(TestCheckProcessDetailActivity.this, R.color.seashell);
                } else {
