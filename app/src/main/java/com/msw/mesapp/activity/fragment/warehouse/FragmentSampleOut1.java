...
import com.msw.mesapp.activity.home.warehouse.SampleInActivityDetial1;
import com.msw.mesapp.activity.home.warehouse.SampleOutActivityDetial1;
...
//样品待领取
public class FragmentSampleOut1 extends Fragment {
    ...
    private void initData() {
        list.clear();
        page = 0;
        EasyHttp.post(GlobalApi.WareHourse.SampleOut.getGodownTestInformHeadersByStatusByPage)
                .params(GlobalApi.WareHourse.status, "0") //状态：未领取
                    ...
                    public void onSuccess(String result) {
                        ...
                        try {
                            ...
                            for (int i = 0; i < content.length(); i++) {
                                ...
                                String materia_name = content0.optJSONObject("rawType").optString("name");
                                String company = content0.optJSONObject("supplier").optString("name");
                                String createTime = DateUtil.getDateToString(Long.valueOf(content0.optString("createTime")));

                                Map listmap = new HashMap<>();
                                listmap.put("0", materia_name); //
                                listmap.put("1", company); //
                                listmap.put("2", createTime); //
            ...
            protected void convert(ViewHolder holder, final Map s, final int position) {
                holder.setOnClickListener(R.id.item, new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        ActivityUtil.switchTo(getActivity(), SampleOutActivityDetial1.class, map);
                    }
                });
                holder.setText(R.id.tv1, s.get("0").toString() + " " + s.get("1").toString());
