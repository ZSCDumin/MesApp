 ...
 * 产品审核》已审核
 */
public class TestCheckProductDetailedActivity extends AppCompatActivity {
                ...
                .execute(new SimpleCallBack<String>() {
                    ...
                    public void onSuccess(String result) {
                        ...
                        if (code == 0) {
                            ...
                            childData.childName1 = "测试日期"; childData.childName2=testDate; temp.add(childData);childData = new ChildData();
                            ...
                            ToastUtil.showToast(TestCheckProductDetailedActivity.this, message, ToastUtil.Error);
                        }
                    }

                    @Override
                    public void onError(ApiException e) {
                        ToastUtil.showToast(TestCheckProductDetailedActivity.this, GlobalApi.ProgressDialog.INTERR, ToastUtil.Confusion);
                    }
                });
    }
...
//                ((TextView)holder.getView(R.id.tv2)).setText(data.childName2);
    ...
    private void initTable() {
        ...
        columns.add(new Column("三级控制标准", new Column<>("2016-标准1-21", "purchase1"), new Column<>("标准2", "purchase2")));
        ...
        ICellBackgroundFormat<CellInfo> backgroundFormat = new BaseCellBackgroundFormat<CellInfo>() {
            ...
            public int getBackGroundColor(CellInfo cellInfo) {
                if (cellInfo.row % 2 == 0) {
                    return ContextCompat.getColor(TestCheckProductDetailedActivity.this, R.color.seashell);
                } else {
