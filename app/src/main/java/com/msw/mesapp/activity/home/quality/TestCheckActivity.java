...
public class TestCheckActivity extends AppCompatActivity {
    ...
    public void initSlidingTabLayout() {
        fragmentList.add(new FragmentTestChecking());
        fragmentList.add(new FragmentTestChecked());
    ...
    public void initPopup() {
        ...
        titlePopup.setItemOnClickListener(new TitlePopup.OnItemOnClickListener() {
            ...
            public void onItemClick(TitlePopup.ActionItem item, int position) {
                switch (position){
                    case 0:
                        ActivityUtil.switchTo(TestCheckActivity.this,TestCheck2Activity.class);
                        finish();
                        break;
                    default:
                        break;
