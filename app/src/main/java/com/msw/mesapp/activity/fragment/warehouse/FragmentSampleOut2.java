...
import com.msw.mesapp.activity.home.warehouse.SampleInActivityDetial2;
import com.msw.mesapp.activity.home.warehouse.SampleOutActivityDetial2;
...
//样品已领取
public class FragmentSampleOut2 extends Fragment {
    ...
    private void initData() {
        ...
        EasyHttp.post(GlobalApi.WareHourse.SampleOut.getGodownTestInformHeadersByStatusByPage)
                .params(GlobalApi.WareHourse.status, "1") //状态：未领取
            ...
            protected void convert(ViewHolder holder, final Map s, final int position) {
                holder.setOnClickListener(R.id.item, new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        ActivityUtil.switchTo(getActivity(), SampleOutActivityDetial2.class, map);
                    }
                });
