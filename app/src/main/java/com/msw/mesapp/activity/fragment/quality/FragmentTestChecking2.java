...
import com.msw.mesapp.activity.home.quality.TestCheck2DetailingActivity;
...
public class FragmentTestChecking2 extends Fragment {
    ...
    private void initData() {
        ...
        EasyHttp.post(GlobalApi.Quality.RawLithium.ByPage.PATH)
                .params(GlobalApi.Quality.RawLithium.ByPage.statusCode, "1") //1代表未审核未发布
            ...
            protected void convert(ViewHolder holder, final Map s, final int position) {
                holder.setOnClickListener(R.id.item, new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        ActivityUtil.switchTo(getActivity(), TestCheck2DetailingActivity.class,map);
                        //getActivity().finish();
                    }
                });
