...
public class FragmentRepairScoreed extends Fragment {
    ...
    private void initData() {
        ...
        page = 0;
        EasyHttp.post(GlobalApi.Repair.PATH_SCORE)
            ...
            protected void convert(ViewHolder holder, final Map s, final int position) {
                holder.setOnClickListener(R.id.item, new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        ActivityUtil.switchTo(getActivity(), RepairScoreDetail2Activity.class,map);
                        getActivity().finish();
                    }
                });
