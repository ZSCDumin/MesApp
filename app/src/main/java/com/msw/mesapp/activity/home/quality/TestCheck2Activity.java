...
import com.msw.mesapp.activity.fragment.quality.FragmentTestChecked;
import com.msw.mesapp.activity.fragment.quality.FragmentTestChecked2;
import com.msw.mesapp.activity.fragment.quality.FragmentTestChecking;
import com.msw.mesapp.activity.fragment.quality.FragmentTestChecking2;
 ...
 * 原料审核》碳酸锂
 */
public class TestCheck2Activity extends AppCompatActivity {
    ...
    public void initSlidingTabLayout() {
        fragmentList.add(new FragmentTestChecking2());
        fragmentList.add(new FragmentTestChecked2());
    ...
    public void initPopup() {
        ...
        //给标题栏弹窗添加子类
        titlePopup.addAction(new TitlePopup.ActionItem(this, "前驱体", R.drawable.mm_title_btn_keyboard_normal));
        titlePopup.setItemOnClickListener(new TitlePopup.OnItemOnClickListener() {
            @Override
            public void onItemClick(TitlePopup.ActionItem item, int position) {
                switch (position){
                    case 0:
                        ActivityUtil.switchTo(TestCheck2Activity.this,TestCheckActivity.class);
                        finish();
                        break;
                    default:
                        break;
