...
import com.msw.mesapp.activity.home.warehouse.ProductOutActivityDetail2;
 ...
 * 成品已出库
 */
public class FragmentProductOut2 extends Fragment {
            ...
            protected void convert(ViewHolder holder, final Map s, final int position) {
                holder.setOnClickListener(R.id.item, new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        ActivityUtil.switchTo(getActivity(), ProductOutActivityDetail2.class, map);
                    }
                });
