...
//样品入库-》未入库
public class FragmentSampleIn2 extends Fragment {
    ...
    private void initData() {
        list.clear();
        page = 0;
        EasyHttp.post(GlobalApi.WareHourse.SampleIn.PATH_Header_ByPage)
                    ...
                    public void onSuccess(String result) {
                        ...
                        try {
                            ...
                            for (int i = 0; i < content.length(); i++) {
                                ...
                                JSONObject departmentobj = content0.optJSONObject("department");
                                String department = "";
                                ...
                                listmap.put("1", materia_name); //收文部门+原料名字
            ...
            protected void convert(ViewHolder holder, final Map s, final int position) {
                holder.setOnClickListener(R.id.item, new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        ActivityUtil.switchTo(getActivity(), SampleInActivityDetial2.class,map);
                    }
                });
                        ...
                        public void onSuccess(String result) {
                            ...
                            try {
                                ...
                                for (int i = 0; i < content.length(); i++) {
                                    ...
                                    Map listmap = new HashMap<>();
                                    listmap.put("1", department+":"+materia_name); //收文部门+原料名字
                                    listmap.put("2", DownDate); //
                                    listmap.put("3", head_code); //
                                    list.add(listmap);
                                }
