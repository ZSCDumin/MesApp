...
import com.msw.mesapp.activity.home.quality.TestReleaseDetailingActivity;
...
public class FragmentTestReleaseing extends Fragment {
    ...
    private void initData() {
        ...
        EasyHttp.post(GlobalApi.Quality.RawPresoma.ByPage.PATH)
                .params(GlobalApi.Quality.RawPresoma.ByPage.statusCode, "2") //1代表未审核未发布
                .params(GlobalApi.Quality.RawPresoma.ByPage.page, String.valueOf(page)) //从第0 业开始获取
            ...
            protected void convert(ViewHolder holder, final Map s, final int position) {
                holder.setOnClickListener(R.id.item, new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        ActivityUtil.switchTo(getActivity(), TestReleaseDetailingActivity.class,map);
                        //getActivity().finish();
                    }
                });
