...
import com.msw.mesapp.activity.home.quality.TestCheckProcessedDetailActivity;
...
public class FragmentTestCheckProcessed1 extends Fragment {
            ...
            protected void convert(ViewHolder holder, final Map s, final int position) {
                holder.setOnClickListener(R.id.item, new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        ActivityUtil.switchTo(getActivity(), TestCheckProcessedDetailActivity.class,map);
                        //getActivity().finish();
                    }
                });
