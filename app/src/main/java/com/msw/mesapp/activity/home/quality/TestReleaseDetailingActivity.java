 ...
 * 原料发布》前驱体》未发布
 */
public class TestReleaseDetailingActivity extends AppCompatActivity {
    ...
    private void initData() {
        ...
        id = (String) SPUtil.get(TestReleaseDetailingActivity.this, GlobalKey.Login.CODE, id);
                ...
                .execute(new SimpleCallBack<String>() {
                    ...
                    public void onSuccess(String result) {
                        ...
                        if (code == 0) {
                            ...
                            ToastUtil.showToast(TestReleaseDetailingActivity.this, message, ToastUtil.Error);
                        }
                    }

                    @Override
                    public void onError(ApiException e) {
                        ToastUtil.showToast(TestReleaseDetailingActivity.this, GlobalApi.ProgressDialog.INTERR, ToastUtil.Confusion);
                    }
                });
    }
    ...
    private void initView() {
        ...
        bt.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                EasyHttp.post(GlobalApi.Quality.RawPresoma.Publish.PATH)
                        ...
                        .params(GlobalApi.Quality.RawPresoma.Publish.statusCode, "3") //状态编码,3是发布状态
                        .sign(true)
                        .timeStamp(true)//本次请求是否携带时间戳
                        .execute(new SimpleCallBack<String>() {
                            @Override
                            public void onSuccess(String result) {
                                ...
                                if (code == 0) {
                                    ToastUtil.showToast(TestReleaseDetailingActivity.this, message, ToastUtil.Success);
                                    finish();
                                } else {
                                    ToastUtil.showToast(TestReleaseDetailingActivity.this, message, ToastUtil.Error);
                                }
    ...
    private void initTable() {
        ...
        ICellBackgroundFormat<CellInfo> backgroundFormat = new BaseCellBackgroundFormat<CellInfo>() {
            ...
            public int getBackGroundColor(CellInfo cellInfo) {
                if (cellInfo.row % 2 == 0) {
                    return ContextCompat.getColor(TestReleaseDetailingActivity.this, R.color.seashell);
                } else {
