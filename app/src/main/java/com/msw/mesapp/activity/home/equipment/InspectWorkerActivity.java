            ...
            protected void convert(ViewHolder holder, Map s, final int position) {
                ...
                holder.setOnClickListener(R.id.bt1, new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        ActivityUtil.switchTo(InspectWorkerActivity.this,InspectWorkerDetailActivity.class);
                ...
                holder.setOnClickListener(R.id.bt2, new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        ActivityUtil.switchTo(InspectWorkerActivity.this,InspectWorkerJudgeActivity.class);
                        SPUtil.put(InspectWorkerActivity.this, "inspectnum", "13");
                        finish();
                    }
                });
            }
