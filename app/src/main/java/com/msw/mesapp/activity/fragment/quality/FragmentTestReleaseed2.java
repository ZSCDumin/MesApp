...
import com.msw.mesapp.activity.home.quality.TestRelease2DetailedActivity;
...
public class FragmentTestReleaseed2 extends Fragment {
    ...
    private void initData() {
        ...
        EasyHttp.post(GlobalApi.Quality.RawLithium.ByPage.PATH)
                .params(GlobalApi.Quality.RawLithium.ByPage.statusCode, "3") //2代表已审核未发布
                .params(GlobalApi.Quality.RawLithium.ByPage.page, String.valueOf(page)) //从第0 页开始获取
            ...
            protected void convert(ViewHolder holder, final Map s, final int position) {
                holder.setOnClickListener(R.id.item, new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        ActivityUtil.switchTo(getActivity(), TestRelease2DetailedActivity.class,map);
                        //getActivity().finish();
                    }
                });
