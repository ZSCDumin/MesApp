...
public class FragmentTestCheckProcess1 extends Fragment {
    ...
    private void initData() {
        ...
        EasyHttp.post(GlobalApi.Quality.ProcessPremix.ByPage.PATH)
                .params(GlobalApi.Quality.ProcessPremix.ByPage.statusCode, "1") //1代表未审核未发布
            ...
            protected void convert(ViewHolder holder, final Map s, final int position) {
                holder.setOnClickListener(R.id.item, new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        ActivityUtil.switchTo(getActivity(), TestCheckProcessDetailActivity.class,map);
                        //getActivity().finish();
                    }
                });
