...
import com.msw.mesapp.activity.fragment.quality.FragmentTestReleaseed2;
import com.msw.mesapp.activity.fragment.quality.FragmentTestReleaseing;
import com.msw.mesapp.activity.fragment.quality.FragmentTestReleaseing2;
...
public class TestRelease2Activity extends AppCompatActivity {
    ...
    public void initPopup() {
        ...
        titlePopup.setItemOnClickListener(new TitlePopup.OnItemOnClickListener() {
            ...
            public void onItemClick(TitlePopup.ActionItem item, int position) {
                switch (position){
                    case 0:
                        ActivityUtil.switchTo(TestRelease2Activity.this,TestReleaseActivity.class);
                        finish();
                        break;
                    default:
                        break;
