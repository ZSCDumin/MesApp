...
public class SampleOutActivityDetial1 extends AppCompatActivity {
                ...
                .execute(new SimpleCallBack<String>() {
                    ...
                    public void onSuccess(String result) {
                        ...
                        if (code == 0) {
                            ...
                            ToastUtil.showToast(SampleOutActivityDetial1.this, message, ToastUtil.Error);
                        }
                    }

                    @Override
                    public void onError(ApiException e) {
                        ToastUtil.showToast(SampleOutActivityDetial1.this, GlobalApi.ProgressDialog.INTERR, ToastUtil.Confusion);
                    }
                });
    }
    ...
    public void initView() {
        ...
        spinner.setOnItemSelectedListener(new Spinner.OnItemSelectedListener() {//选择item的选择点击监听事件
            public void onItemSelected(AdapterView<?> arg0, View arg1,
                ...
                ToastUtil.showToast(SampleOutActivityDetial1.this, "选择了" + arg2, ToastUtil.Confusion);
            }
        ...
        bt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                ActivityUtil.switchTo(SampleOutActivityDetial1.this, SampleInActivityDetial1Scan.class, map); //扫码验证
            }
        });
    ...
    public void initTable() {
        ...
        ICellBackgroundFormat<CellInfo> backgroundFormat = new BaseCellBackgroundFormat<CellInfo>() {
            ...
            public int getBackGroundColor(CellInfo cellInfo) {
                if (cellInfo.row % 2 == 0) {
                    return ContextCompat.getColor(SampleOutActivityDetial1.this, R.color.seashell);
                } else {
