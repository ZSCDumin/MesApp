...
public class RepairWorkDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_repair_work_detail);
    ...
    public void initView() {
        ...
        bt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                EasyHttp.post(GlobalApi.Repair.Accept.PATH)
                        .params(GlobalApi.Repair.Accept.code, code)
                        .params(GlobalApi.Repair.Accept.repairMan_code, id)
                        .sign(true)
                        .timeStamp(true)//本次请求是否携带时间戳
                        .execute(new SimpleCallBack<String>() {
                            @Override
