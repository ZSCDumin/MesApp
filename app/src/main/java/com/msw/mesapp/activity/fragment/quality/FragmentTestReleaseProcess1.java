...
import com.msw.mesapp.activity.home.quality.TestReleaseProcessDetailActivity;
...
public class FragmentTestReleaseProcess1 extends Fragment {
    ...
    private void initData() {
        list.clear();
        page = 0;
        EasyHttp.post(GlobalApi.Quality.ProcessPremix.ByPage.PATH)
                .params(GlobalApi.Quality.ProcessPremix.ByPage.statusCode, "2") //1代表未审核未发布
                .params(GlobalApi.Quality.ProcessPremix.ByPage.page, String.valueOf(page)) //从第0 业开始获取
                .params(GlobalApi.Quality.ProcessPremix.ByPage.size, "20") //一次获取多少
                .params(GlobalApi.Quality.ProcessPremix.ByPage.sort, "code") //根据code排序
                .params(GlobalApi.Quality.ProcessPremix.ByPage.asc, "1") //升序
                .sign(true)
            ...
            protected void convert(ViewHolder holder, final Map s, final int position) {
                holder.setOnClickListener(R.id.item, new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        map.put("type","1"); //类型，1是预混，2是粉碎粒度，3是碳酸锂，4扣电
                        ActivityUtil.switchTo(getActivity(), TestReleaseProcessDetailActivity.class,map);
                        //getActivity().finish();
                    }
                });
    ...
    private void getData() {
        ...
        if(page > totalPages | list.size() > totalElements)  classicsFooter.setLoadmoreFinished(true);
            ...
            EasyHttp.post(GlobalApi.Quality.ProcessPremix.ByPage.PATH)
                    .params(GlobalApi.Quality.ProcessPremix.ByPage.statusCode, "2") //1代表未审核未发布
                    .params(GlobalApi.Quality.ProcessPremix.ByPage.page, String.valueOf(page))
                    .params(GlobalApi.Quality.ProcessPremix.ByPage.size, "20") //一次获取多少
                    .params(GlobalApi.Quality.ProcessPremix.ByPage.sort, "code") //根据code排序
                    .params(GlobalApi.Quality.ProcessPremix.ByPage.asc, "1")
                    .sign(true)
                    .timeStamp(true)//本次请求是否携带时间戳
                    .execute(new SimpleCallBack<String>() {
                        @Override
