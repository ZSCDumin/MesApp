...
import com.msw.mesapp.activity.fragment.quality.FragmentTestReleaseProcessed1;
import com.msw.mesapp.activity.fragment.quality.FragmentTestReleaseProcessed2;
import com.msw.mesapp.activity.fragment.quality.FragmentTestReleaseProcessed3;
import com.msw.mesapp.activity.fragment.quality.FragmentTestReleaseProcessed4;
...
public class TestReleaseProcessedActivity extends AppCompatActivity {
...
//        title.startAnimation(scaleAnimation);
    ...
    public void initSlidingTabLayout() {
        fragmentList.add(new FragmentTestReleaseProcessed1());
        fragmentList.add(new FragmentTestReleaseProcessed2());
    ...
    public void initPopup() {
        ...
        //给标题栏弹窗添加子类
        titlePopup.addAction(new TitlePopup.ActionItem(this, "未发布", R.drawable.mm_title_btn_keyboard_normal));
        titlePopup.setItemOnClickListener(new TitlePopup.OnItemOnClickListener() {
            @Override
            public void onItemClick(TitlePopup.ActionItem item, int position) {
                //ActivityUtil.toastShow(TestReleaseProcessedActivity.this, "点击了" + item.mTitle.toString());
                switch (position){
                    case 0:
                        ActivityUtil.switchTo(TestReleaseProcessedActivity.this,TestReleaseProcessActivity.class);
                        finish();
                        break;
                    default:
                        break;
