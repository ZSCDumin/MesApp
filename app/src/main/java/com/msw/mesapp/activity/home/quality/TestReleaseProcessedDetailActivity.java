 ...
 * 化验审核之产品审核之详细
 */
public class TestReleaseProcessedDetailActivity extends AppCompatActivity {
    ...
    private void initData() {
        ...
        id = (String) SPUtil.get(TestReleaseProcessedDetailActivity.this, GlobalKey.Login.CODE, id);
                ...
                .execute(new SimpleCallBack<String>() {
                    ...
                    public void onSuccess(String result) {
                        ...
                        if (code == 0) {
                            ...
                            ToastUtil.showToast(TestReleaseProcessedDetailActivity.this, message, ToastUtil.Error);
                        }
                    }

                    @Override
                    public void onError(ApiException e) {
                        ToastUtil.showToast(TestReleaseProcessedDetailActivity.this, GlobalApi.ProgressDialog.INTERR, ToastUtil.Confusion);
                    }
                });
    }
    ...
    private void initTable() {
        ...
        ICellBackgroundFormat<CellInfo> backgroundFormat = new BaseCellBackgroundFormat<CellInfo>() {
            ...
            public int getBackGroundColor(CellInfo cellInfo) {
                if (cellInfo.row % 2 == 0) {
                    return ContextCompat.getColor(TestReleaseProcessedDetailActivity.this, R.color.seashell);
                } else {
