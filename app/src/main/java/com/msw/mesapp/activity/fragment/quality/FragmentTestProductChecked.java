...
import com.msw.mesapp.activity.home.quality.TestCheckProductDetailedActivity;
import com.msw.mesapp.activity.home.quality.TestCheckProductDetailingActivity;
...
public class FragmentTestProductChecked extends Fragment {
    ...
    private void initData() {
        list.clear();
        page = 0;
        EasyHttp.post(GlobalApi.Quality.Product.ByPage.PATH)
                .params(GlobalApi.Quality.Product.ByPage.statusCode, "2") //1代表未审核未发布
                .params(GlobalApi.Quality.Product.ByPage.page, String.valueOf(page)) //从第0 业开始获取
                .params(GlobalApi.Quality.Product.ByPage.size, "20") //一次获取多少
                .params(GlobalApi.Quality.Product.ByPage.sort, "code") //根据code排序
                .params(GlobalApi.Quality.Product.ByPage.asc, "1") //升序
                .sign(true)
            ...
            protected void convert(ViewHolder holder, final Map s, final int position) {
                holder.setOnClickListener(R.id.item, new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        ActivityUtil.switchTo(getActivity(), TestCheckProductDetailedActivity.class,map);
                        //getActivity().finish();
                    }
                });
    ...
    private void getData() {
        ...
        if(page > totalPages)  classicsFooter.setLoadmoreFinished(true);
            ...
            EasyHttp.post(GlobalApi.Quality.Product.ByPage.PATH)
                    .params(GlobalApi.Quality.Product.ByPage.statusCode, "2") //1代表未审核未发布
                    .params(GlobalApi.Quality.Product.ByPage.page, String.valueOf(page))
                    .params(GlobalApi.Quality.Product.ByPage.size, "20") //一次获取多少
                    .params(GlobalApi.Quality.Product.ByPage.sort, "code") //根据code排序
                    .params(GlobalApi.Quality.Product.ByPage.asc, "1")
                    .sign(true)
                    .timeStamp(true)//本次请求是否携带时间戳
                    .execute(new SimpleCallBack<String>() {
                        @Override
