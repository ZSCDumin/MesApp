...
import com.msw.mesapp.activity.home.quality.TestReleaseDetailedActivity;
...
public class FragmentTestReleaseed extends Fragment {
    ...
    private void initData() {
        list.clear();
        page = 0;
        EasyHttp.post(GlobalApi.Quality.RawPresoma.ByPage.PATH)
                .params(GlobalApi.Quality.RawPresoma.ByPage.statusCode, "3") //3代表已审核yi发布
                .params(GlobalApi.Quality.RawPresoma.ByPage.page, String.valueOf(page)) //从第0 页开始获取
                .params(GlobalApi.Quality.RawPresoma.ByPage.size, "20") //一次获取多少
                .params(GlobalApi.Quality.RawPresoma.ByPage.sort, "code") //根据code排序
                .params(GlobalApi.Quality.RawPresoma.ByPage.asc, "1") //升序
                .sign(true)
            ...
            protected void convert(ViewHolder holder, final Map s, final int position) {
                holder.setOnClickListener(R.id.item, new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        ActivityUtil.switchTo(getActivity(), TestReleaseDetailedActivity.class,map);
                        //getActivity().finish();
                    }
                });
    ...
    private void getData() {
        ...
        if(page > totalPages || list.size() > totalElements)  classicsFooter.setLoadmoreFinished(true);
            ...
            EasyHttp.post(GlobalApi.Quality.RawPresoma.ByPage.PATH)
                    .params(GlobalApi.Quality.RawPresoma.ByPage.statusCode, "3") //2代表已审核yi发布
                    .params(GlobalApi.Quality.RawPresoma.ByPage.page, String.valueOf(page))
                    .params(GlobalApi.Quality.RawPresoma.ByPage.size, "20") //一次获取多少
                    .params(GlobalApi.Quality.RawPresoma.ByPage.sort, "code") //根据code排序
                    .params(GlobalApi.Quality.RawPresoma.ByPage.asc, "1")
                    .sign(true)
                    .timeStamp(true)//本次请求是否携带时间戳
                    .execute(new SimpleCallBack<String>() {
                        @Override
