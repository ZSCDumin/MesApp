...
import com.msw.mesapp.activity.home.quality.TestCheckDetailedActivity;
...
public class FragmentTestChecked extends Fragment {
    ...
    private void initData() {
        ...
        EasyHttp.post(GlobalApi.Quality.RawPresoma.ByPage.PATH)
                .params(GlobalApi.Quality.RawPresoma.ByPage.statusCode, "2") //2代表已审核未发布
            ...
            protected void convert(ViewHolder holder, final Map s, final int position) {
                holder.setOnClickListener(R.id.item, new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        ActivityUtil.switchTo(getActivity(), TestCheckDetailedActivity.class,map);
                        //getActivity().finish();
                    }
                });
