 ...
 * 原料发布》碳酸锂》未发布
 */
public class TestRelease2DetailingActivity extends AppCompatActivity {
                ...
                .execute(new SimpleCallBack<String>() {
                    ...
                    public void onSuccess(String result) {
                        ...
                        if (code == 0) {
                            ...
                            ToastUtil.showToast(TestRelease2DetailingActivity.this, message, ToastUtil.Error);
                        }
                    }

                    @Override
                    public void onError(ApiException e) {
                        ToastUtil.showToast(TestRelease2DetailingActivity.this, GlobalApi.ProgressDialog.INTERR, ToastUtil.Confusion);
                    }
                });
    }
    ...
    private void initView() {
        ...
        bt.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                EasyHttp.post(GlobalApi.Quality.RawLithium.Publish.PATH)
                        .params(GlobalApi.Quality.RawLithium.Publish.code, code) //主键
                        .params(GlobalApi.Quality.RawLithium.Publish.publisherCode, id) //审核人编码
                        .params(GlobalApi.Quality.RawLithium.Publish.statusCode, "3") //状态编码,2是审核状态
                        .sign(true)
                        .timeStamp(true)//本次请求是否携带时间戳
                        .execute(new SimpleCallBack<String>() {
                            @Override
                            public void onSuccess(String result) {
                                ...
                                if (code == 0) {
                                    ToastUtil.showToast(TestRelease2DetailingActivity.this, message, ToastUtil.Success);
                                    finish();
                                } else {
                                    ToastUtil.showToast(TestRelease2DetailingActivity.this, message, ToastUtil.Error);
                                }
    ...
    private void initTable() {
        ...
        ICellBackgroundFormat<CellInfo> backgroundFormat = new BaseCellBackgroundFormat<CellInfo>() {
            ...
            public int getBackGroundColor(CellInfo cellInfo) {
                if (cellInfo.row % 2 == 0) {
                    return ContextCompat.getColor(TestRelease2DetailingActivity.this, R.color.seashell);
                } else {
