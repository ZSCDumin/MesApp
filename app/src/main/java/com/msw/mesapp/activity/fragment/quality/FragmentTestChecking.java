...
public class FragmentTestChecking extends Fragment {
    ...
    private void initData() {
        ...
        EasyHttp.post(GlobalApi.Quality.RawPresoma.ByPage.PATH)
                .params(GlobalApi.Quality.RawPresoma.ByPage.statusCode, "1") //1代表未审核未发布
            ...
            protected void convert(ViewHolder holder, final Map s, final int position) {
                holder.setOnClickListener(R.id.item, new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        ActivityUtil.switchTo(getActivity(), TestCheckDetailingActivity.class,map);
                        //getActivity().finish();
                    }
                });
