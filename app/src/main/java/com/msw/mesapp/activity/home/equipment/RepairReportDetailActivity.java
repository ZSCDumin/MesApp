                ...
                .execute(new SimpleCallBack<String>() {
                    ...
                    public void onSuccess(String result) {
                        ...
                        if (code == 0) {
                            ...
                            ToastUtil.showToast(RepairReportDetailActivity.this, message, ToastUtil.Error);
                        }
                    }
                    @Override
                    public void onError(ApiException e) {
                        ToastUtil.showToast(RepairReportDetailActivity.this, GlobalApi.ProgressDialog.INTERR, ToastUtil.Confusion);
                    }
                });
    }
