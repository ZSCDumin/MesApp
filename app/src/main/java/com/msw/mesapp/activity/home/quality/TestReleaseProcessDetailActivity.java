 ...
 * 化验审核之产品审核之详细
 */
public class TestReleaseProcessDetailActivity extends AppCompatActivity {
    ...
    private void initData() {
        ...
        id = (String) SPUtil.get(TestReleaseProcessDetailActivity.this, GlobalKey.Login.CODE, id);
                ...
                .execute(new SimpleCallBack<String>() {
                    ...
                    public void onSuccess(String result) {
                        ...
                        if (code == 0) {
                            ...
                            ToastUtil.showToast(TestReleaseProcessDetailActivity.this, message, ToastUtil.Error);
                        }
                    }

                    @Override
                    public void onError(ApiException e) {
                        ToastUtil.showToast(TestReleaseProcessDetailActivity.this, GlobalApi.ProgressDialog.INTERR, ToastUtil.Confusion);
                    }
                });
    }
    ...
    private void initView() {
        ...
        String Path = "";
        switch (ctype){
            case "1": Path = GlobalApi.Quality.ProcessPremix.Publish.PATH;break;
            case "2": Path = GlobalApi.Quality.ProcessSize.Publish.PATH;break;
            case "3": Path = GlobalApi.Quality.ProcessLithium.Publish.PATH;break;
            case "4": Path = GlobalApi.Quality.ProcessBuckle.Publish.PATH;break;
            default:Path = GlobalApi.Quality.ProcessPremix.Publish.PATH;break;
        }
        bt.setText("发布");
        ...
        bt.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                EasyHttp.post(finalPath)
                        .params(GlobalApi.Quality.RawPresoma.Publish.code, code) //主键
                        .params(GlobalApi.Quality.RawPresoma.Publish.publisherCode, id) //审核人编码
                        .params(GlobalApi.Quality.RawPresoma.Publish.statusCode, "3") //状态编码,2是审核状态
                        .sign(true)
                        .timeStamp(true)//本次请求是否携带时间戳
                        .execute(new SimpleCallBack<String>() {
                            @Override
                            public void onSuccess(String result) {
                                ...
                                if (code == 0) {
                                    ToastUtil.showToast(TestReleaseProcessDetailActivity.this, message, ToastUtil.Success);
                                    finish();
                                } else {
                                    ToastUtil.showToast(TestReleaseProcessDetailActivity.this, message, ToastUtil.Error);
                                }
    ...
    private void initTable() {
        ...
        ICellBackgroundFormat<CellInfo> backgroundFormat = new BaseCellBackgroundFormat<CellInfo>() {
            ...
            public int getBackGroundColor(CellInfo cellInfo) {
                if (cellInfo.row % 2 == 0) {
                    return ContextCompat.getColor(TestReleaseProcessDetailActivity.this, R.color.seashell);
                } else {
