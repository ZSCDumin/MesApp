...
/**
 * Created by Mr.Meng on 2018/1/20.
 */
/**
...
public final class SystemInfoUtil {
    ...
    public static String getUserAgent(Context context, String appId) {
        String userAgent = appId +// 应用名称
                ...
                CommonConsts.SEMICOLON +
                SystemInfoUtil.getOSVersionName() + // OS版本
                CommonConsts.SEMICOLON +
                SystemInfoUtil.getOSVersionDisplayName() + // OS显示版本
                CommonConsts.SEMICOLON +
                SystemInfoUtil.getBrandName() + // 品牌厂商
                CommonConsts.SEMICOLON +
                SystemInfoUtil.getModelName() + // 设备
                CommonConsts.SEMICOLON +
               // DensityUtil.getPhoneSize(context) + // 分辨率
                CommonConsts.SEMICOLON +
                SystemInfoUtil.getAppSource(context, CommonConsts.APP_SOURCE) + // 分发渠道
                CommonConsts.SEMICOLON +
                SystemInfoUtil.getNetType(context) + // 网络类型
                CommonConsts.SEMICOLON;
        // ==============================================================
//		User-Agent
//		格式：
